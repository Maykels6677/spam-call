#!/usr/bin/python2
# Author : Mr.Maykels
# Team : Rabbit Security Team ( RST - X666X )
...
def main():
	...
	try:
		...
		if pilih == '1':
			...
			print
			os.system('xdg-open https://github.com/Maykels6677')
			sleep(2)
			...
			print
			os.system('xdg-open https://www.youtube.com/channel/UCc_ZjU11DWSYwVDetrP280Q')
			sleep(2)
